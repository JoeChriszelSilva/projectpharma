...
function Home() {
  const imageUrl = "https://i.imgur.com/MMdNT2m.png";
        ...
        <div className="flex flex-col justify-center gap-6 p-4">
          ...
          <div className="flex justify-start mt-6">
            <Link
              to="/categorias"
              className="
                            px-8 py-3 text-lg font-semibold text-blue 
                            bg-parque-tamara rounded-lg 
                            shadow-lg hover:bg-parque-lenha transition-colors
